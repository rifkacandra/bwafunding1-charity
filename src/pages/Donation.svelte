<script>
   ...
   async function handleForm(event) {
      ...
      charity.pledged = newData.pledged + parseInt(amount);
      try {
...
style="background-image:url('/assets/images/rifka.jpg')">
...
<!-- .xs-input-group END -->
<div class="xs-donat-group">
<label for="xs-donate-name">
   Your Name
   <span clas="color-light-red">**</span>
</label>
<input
type="text"
name="name"
...
"badge"><i class="fa fa-heart"></i></span>
Donate now
</button>
